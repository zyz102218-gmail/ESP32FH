...
void OnDataRecv(const uint8_t *mac_addr, const uint8_t *incomingData, int len)
{
  ...
  {              //执行mapping
    ...
    a2_servo.write(int(mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 40, 120)));
    a3_servo.write(int(mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 40, 110)));
    a4_servo.write(int(mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 100, 180)));
    a5_servo.write(int(mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 35, 150)));
    //测试代码结束
