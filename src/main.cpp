...
void OnDataRecv(const uint8_t *mac_addr, const uint8_t *incomingData, int len)
{
  ...
  {              //执行mapping
    ...
    //一个手指测试用
    fingers["a1"] = mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 50, 150);
    fingers["a2"] = mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 40, 120);
    fingers["a3"] = mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 40, 110);
    fingers["a4"] = mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 100, 180);
    fingers["a5"] = mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 35, 150);
    a1_servo.write(int(mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 50, 150)));
    a2_servo.write(int(mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 120, 40)));
    a3_servo.write(int(mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 110, 40)));
    a4_servo.write(int(mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 100, 180)));
    a5_servo.write(int(mapping(incomingReadings.a1, MIN->Finger1, MAX->Finger1, 150, 35)));
    //测试代码结束
